        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.3s">
                    <div class="text-white mb-3">Hand Exercise 1</div>
                    <h1 class="mb-4 text-white ">Hand Strengthening Exercise</h1>
                    <p class="mb-4 text-light ">This exercise is designed to help you improve the strength and flexibility of your hands through guided movements. Follow along with the instructional video to perform a series of open and close hand exercises, specifically tailored for your rehabilitation needs.</p>
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    ...
                    <video class="local_video" controls>
                        <source src="vid/Hand Strengthening Without Tool.mp4" type="video/mp4">
                    ...
                    <div class="alert alert-success mt-3">
                        ...
                        <div id="handCounts" class="hand-counts">
                            <p class="mb-0">Open Hands: <span id="openHandCount">0</span></p>
                            <p class="mb-0">Closed Hands: <span id="closedHandCount">0</span></p>
                        </div>
