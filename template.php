   ...
   <!-- <div class="topbar d-flex align-items-center">
    ...
    <ul>
        ...
        <?php if ($is_logged_in): ?>
            ...
            <li><a href="template.php" class="active">Consent Form</a></li>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Consent Form</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
...
<section id="template" class="template section">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Consent Form for RIOT Platform</h2>
        <p>Our consent form provides important information about using our platform, data privacy, and security measures. This form ensures that you understand how RIOT will support your rehabilitation goals and how your data will be protected.
        </p>
      </div>
      ...
      <div class="consent-form-container">
        ...
        <div class="consent-download">
          <a href="assets\BORANG_KEIZINAN.pdf" download class="btn-download">
